...
export const researchSchema = z.object({
  ...
  estimated_monthly_revenue: z.coerce.number().int().min(0).nullable().optional(),
  estimated_fba_fee: z.coerce.number().min(0).nullable().optional(),
  seller_count_fba: z.coerce.number().int().min(0).nullable().optional(),
