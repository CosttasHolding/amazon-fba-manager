        ...
        <div className="flex h-[calc(85vh-65px)]">
          ...
          <div className="w-64 border-e border-border flex flex-col">
            <div className="p-3 border-b border-border">
              <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider">{t("help.sections_title", locale)}</p>
            </div>
              ...
              <div className="p-2 space-y-0.5">
                {HELP_SECTIONS.map((section) => (
                  <button
                    ...
                    className={cn(
                      "w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm transition-all duration-200 text-start",
          ...
          <div className="flex-1 overflow-y-auto" ref={contentRef}>
            <div className="p-6 space-y-8">
              {activeSection === "glossary" ? (
                ...
                <SectionContent section={currentSection} locale={locale} />
              )}
            </div>
          </div>
        </div>
...
function SectionContent({ section, locale }: { section: HelpSection; locale: Locale }) {
  return (
...
function GlossaryContent({ locale }: { locale: Locale }) {
  return (
    <div id="help-section-glossary" className="space-y-6">
      <div>
            <h2 className="text-xl font-bold text-foreground font-display">{t("help.glossary_title", locale)}</h2>
        <p className="text-sm text-muted-foreground mt-1">
          {t("help.glossary_desc", locale)}
        </p>
      </div>
